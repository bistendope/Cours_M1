...
public class Model3D {
    ...
    void init(String vertexShader, String fragmentShader, String vertexLoc,
              String normalLoc, String texLoc, int texture, int index ){


        mProgram = GLES32.glCreateProgram();

        mVertexShaderID = ShadderUtilities.loadShader(GLES32.GL_VERTEX_SHADER, vertexShader);
        mFragShaderID = ShadderUtilities.loadShader(GLES32.GL_FRAGMENT_SHADER, fragmentShader);
        ...
        ShadderUtilities.loadTexture(texture, mTextureID, index);
    ...
    void draw(float[] projection, float[] view, float[] model,int index){
