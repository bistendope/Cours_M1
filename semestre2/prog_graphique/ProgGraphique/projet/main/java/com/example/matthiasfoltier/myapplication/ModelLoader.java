...
public class ModelLoader {
    ...
    public static com.example.matthiasfoltier.myapplication.Model3D readOBJFile(final Context c, final String filename) {
        try {
            ...
            return new com.example.matthiasfoltier.myapplication.Model3D(vertices, normals, UVs, indices);
        } catch (IOException e) {
