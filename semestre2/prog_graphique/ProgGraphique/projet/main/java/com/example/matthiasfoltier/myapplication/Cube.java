...
public class Cube {
    ...
    public Cube() {
        ...
        int vertexShader = ShadderUtilities.loadShader(GLES32.GL_VERTEX_SHADER,
                "vertexshader.vert");
        int fragShader = ShadderUtilities.loadShader(GLES32.GL_FRAGMENT_SHADER,
                "fragmentshader.frag");
        ...
        ShadderUtilities.loadTexture(R.drawable.brick, texID, 0);


        GLES32.glActiveTexture(GLES32.GL_TEXTURE1);
        ShadderUtilities.loadTexture(R.drawable.normal_map, texID, 1);
